...
{
  new (message_memory) yolo_interface::msg::ImageMsg(_init);
}

void ImageMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<yolo_interface::msg::ImageMsg *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ImageMsg_message_member_array[6] = {
  {
    "height",  // name
    ...
    offsetof(yolo_interface::msg::ImageMsg, height),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yolo_interface::msg::ImageMsg, width),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yolo_interface::msg::ImageMsg, encoding),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yolo_interface::msg::ImageMsg, is_bigendian),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yolo_interface::msg::ImageMsg, step),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yolo_interface::msg::ImageMsg, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ImageMsg_message_members = {
  ...
  6,  // number of fields
  sizeof(yolo_interface::msg::ImageMsg),
...
{
  return &::yolo_interface::msg::rosidl_typesupport_introspection_cpp::ImageMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolo_interface, msg, ImageMsg)() {
  return &::yolo_interface::msg::rosidl_typesupport_introspection_cpp::ImageMsg_message_type_support_handle;
}
