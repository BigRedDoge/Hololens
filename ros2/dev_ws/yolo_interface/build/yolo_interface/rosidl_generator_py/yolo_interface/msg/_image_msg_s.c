...
bool yolo_interface__msg__image_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yolo_interface.msg._image_msg.ImageMsg", full_classname_dest, 38) == 0);
  }
  yolo_interface__msg__ImageMsg * ros_message = _ros_message;
  {  // height
...
PyObject * yolo_interface__msg__image_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yolo_interface.msg._image_msg");
