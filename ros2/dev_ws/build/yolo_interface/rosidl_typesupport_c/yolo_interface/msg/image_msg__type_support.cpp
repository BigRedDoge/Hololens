...
#include "yolo_interface/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _ImageMsg_type_support_symbol_names_t _ImageMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yolo_interface, msg, ImageMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, yolo_interface, msg, ImageMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_yolo_interface
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, yolo_interface, msg, ImageMsg)() {
  return &::yolo_interface::msg::rosidl_typesupport_c::ImageMsg_message_type_support_handle;
}
